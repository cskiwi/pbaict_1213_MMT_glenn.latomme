...
namespace ModelsDemo {
    ...
    public class ModelsGame : Game {
        ...
        private void DrawModel(GameTime gameTime, bool drawOpaqueOnly) {
            ...
            var cameraPosition = new Vector3(0.0f, _modelBoundingSpheres[_activeModel].Radius*2,
                                             _modelBoundingSpheres[_activeModel].Radius*2.0f);
            var lookAt = new Vector3(0.0f, 0, 0.0f);

            // Copy any parent transforms.
            var transforms = new Matrix[_models[_activeModel].Bones.Count];
